...
def _lint_spec(profile: dict[str, Any]) -> list[dict[str, str]]:
    ...
    # Measured on Qwen3.8-27B (SPEED-Bench coding+writing, 16 prompts, short ctx):
    # n_max 3 gave 54.2 tok/s, n_max 7 gave 49.7 fixed and 49.3 with --spec-draft-adaptive.
    # Adaptive does NOT rescue a too-deep ceiling, so this warns regardless of it.
