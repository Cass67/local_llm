...
assert_contains "$readme_contents" "bash -n scripts/oc-local scripts/model-manager.sh scripts/update-manager.sh scripts/model-discovery.sh scripts/hardware-analyzer.sh installer.sh"
assert_contains "$readme_contents" "shellcheck scripts/oc-local scripts/model-manager.sh scripts/update-manager.sh scripts/model-discovery.sh scripts/hardware-analyzer.sh installer.sh"
...
assert_contains "$fastlong_output" "context=40960"
assert_contains "$fastlong_output" "remote_start=./start3.sh fastlong"
assert_contains "$fastlong_output" "model=localllm/qwen3.6-35b-a3b"
assert_contains "$fastlong_output" '"qwen3.6-35b-a3b":{"name":"qwen3.6-35b-a3b"'
